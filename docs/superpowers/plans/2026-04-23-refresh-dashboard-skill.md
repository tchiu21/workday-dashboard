...
**Spec reference:** `docs/superpowers/specs/2026-04-23-refresh-workday-dashboard-skill-design.md`
...
- Create: `~/.claude/skills/refresh-workday-dashboard/SKILL.md` — orchestrator with frontmatter + flow
- Create: `~/.claude/skills/refresh-workday-dashboard/jira.md` — Jira queries via MCP
- Create: `~/.claude/skills/refresh-workday-dashboard/github.md` — GitHub PR queries via MCP
- Create: `~/.claude/skills/refresh-workday-dashboard/slack-attention.md` — mentions + unanswered @devs pings
- Create: `~/.claude/skills/refresh-workday-dashboard/slack-work-mining.md` — DM + thread mining for uncaptured work
...
**Files:**
- Create: `~/.claude/skills/refresh-workday-dashboard/SKILL.md`
- Create: `~/.claude/skills/refresh-workday-dashboard/jira.md` (stub)
- Create: `~/.claude/skills/refresh-workday-dashboard/github.md` (stub)
- Create: `~/.claude/skills/refresh-workday-dashboard/slack-attention.md` (stub)
- Create: `~/.claude/skills/refresh-workday-dashboard/slack-work-mining.md` (stub)

- [ ] **Step 1: Create the skill directory**

```bash
mkdir -p ~/.claude/skills/refresh-workday-dashboard
```

Verify:
```bash
ls -la ~/.claude/skills/refresh-workday-dashboard
```
Expected: empty directory.

- [ ] **Step 2: Create SKILL.md with frontmatter + high-level flow (no sub-agent dispatch yet)**

Write `~/.claude/skills/refresh-workday-dashboard/SKILL.md`:

````markdown
---
name: refresh-workday-dashboard
...
> The dashboard repo is not at `/Users/tommy.chiu/code/workday-dashboard`. Edit the path in `~/.claude/skills/refresh-workday-dashboard/SKILL.md` under "Configuration" to point to the current location of the repo, then retry.
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/jira.md`
...
Replace the stub content in `~/.claude/skills/refresh-workday-dashboard/jira.md` with:

````markdown
---
name: jira-source
description: Ref file for the refresh-workday-dashboard skill. Gathers Jira issues for the user from the RETIRE project, categorizing into done / in_progress / up_next.
---
...
```bash
grep -c "^### " ~/.claude/skills/refresh-workday-dashboard/jira.md
```
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/github.md`
...
Replace the stub content in `~/.claude/skills/refresh-workday-dashboard/github.md` with:

````markdown
---
name: github-source
description: Ref file for the refresh-workday-dashboard skill. Gathers GitHub PRs for the user from Gusto/app, categorizing into done / in_progress / up_next.
---
...
```bash
wc -l ~/.claude/skills/refresh-workday-dashboard/github.md
```
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/slack-attention.md`
...
Replace the stub content in `~/.claude/skills/refresh-workday-dashboard/slack-attention.md` with:

````markdown
---
name: slack-attention-source
description: Ref file for the refresh-workday-dashboard skill. Gathers Slack attention items — bot mentions + unanswered @retirement-compliance-devs pings.
---
...
```bash
wc -l ~/.claude/skills/refresh-workday-dashboard/slack-attention.md
```
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/slack-work-mining.md`
...
description: Ref file for the refresh-workday-dashboard skill. Mines DMs and threads the user participated in for work they've described but haven't captured in Jira or GitHub.
---
...
```bash
grep -c "^### " ~/.claude/skills/refresh-workday-dashboard/slack-work-mining.md
```
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/SKILL.md` — replace stub Steps 4 and 5

- [ ] **Step 1: Replace Step 4 in SKILL.md with real parallel dispatch**

In `~/.claude/skills/refresh-workday-dashboard/SKILL.md`, find the block:
...
1. **jira-agent:**
   > Read `~/.claude/skills/refresh-workday-dashboard/jira.md`. Follow its Procedure exactly with `window_start_iso = {{window_start_iso}}`. Return only a JSON object of shape `{ "done": [...], "in_progress": [...], "up_next": [...], "warning": null | "..." }`. Under 200 words of commentary outside the JSON.

2. **github-agent:**
   > Read `~/.claude/skills/refresh-workday-dashboard/github.md`. Follow its Procedure exactly with `window_start_iso = {{window_start_iso}}`. Return only a JSON object of shape `{ "done": [...], "in_progress": [...], "up_next": [...], "warning": null | "..." }`. Under 200 words of commentary outside the JSON.

3. **slack-attention-agent:**
   > Read `~/.claude/skills/refresh-workday-dashboard/slack-attention.md`. Follow its Procedure exactly with `window_start_ts = {{window_start_ts}}`. Return only a JSON array of attention items and optionally a `warning` field — wrap in `{ "items": [...], "warning": null | "..." }`. Under 200 words of commentary outside the JSON.

4. **slack-work-mining-agent:**
   > Read `~/.claude/skills/refresh-workday-dashboard/slack-work-mining.md`. Follow its Procedure exactly with `window_start_ts = {{window_start_ts}}`. Return only a JSON array wrapped as `{ "items": [...], "warning": null | "..." }`. Under 200 words of commentary outside the JSON.
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/SKILL.md` — replace Step 6 stub
...
**Files:**
- Modify: `~/.claude/skills/refresh-workday-dashboard/SKILL.md` — replace Steps 7, 8, 9 stubs
...
Data is now populated by the refresh-workday-dashboard skill (user-level,
~/.claude/skills/refresh-workday-dashboard/) using MCP connections. No API
